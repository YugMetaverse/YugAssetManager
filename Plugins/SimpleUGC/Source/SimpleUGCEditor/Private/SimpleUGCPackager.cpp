...
void FSimpleUGCPackager::PackagePlugin(TSharedRef<class IPlugin> Plugin, const FString& OutputDirectory)
{
	...
	//Setup new OptionalAnalyticsParamArray (Currently nullptr for placeholder)
	TArray<FAnalyticsEventAttribute>* OptionalAnalyticsParamArray = nullptr;
	...
	IUATHelperModule::Get().CreateUatTask(CommandLine, PlatformName, PackagingText,
	                                      PackagingText, FSimpleUGCEditorStyle::Get().GetBrush(TEXT("SimpleUGCEditor.PackageUGCAction")), OptionalAnalyticsParamArray,
